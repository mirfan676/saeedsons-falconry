...
const products=[
 ...
 {name:'Falcon Perch â€” Natural Finish',cat:'Blocks & Perches',image:'/brand/raw/perch-01.jpeg',tag:'Local range',desc:'A stable perch photographed from the Saeed Sons Falconry collection'},
 {name:'Falcon Perch â€” Field Finish',cat:'Blocks & Perches',image:'/brand/raw/perch-02.jpeg',tag:'Field equipment',desc:'Practical perch and block forms for the field'},
 {name:'Falcon Hood â€” Hand Finished',cat:'Falcon Hoods',image:'/brand/raw/hood-01.jpeg',tag:'Local range',desc:'Hand-finished hood from the Saeed Sons Falconry workshop'},
 {name:'Falcon Hood â€” Profile',cat:'Falcon Hoods',image:'/brand/raw/hood-02.jpeg',tag:'Craft detail',desc:'A close product view of the hood profile and stitching'},
 {name:'Falcon Hood â€” Classic',cat:'Falcon Hoods',image:'/brand/raw/hood-03.jpeg',tag:'Field ready',desc:'A classic hood style available by direct enquiry'}
];
const collections=[
...
function StoryPage({type}){
 const data={history:{eyebrow:'01 â€” OUR STORY',title:'Established in 2010.',intro:'From Karachi, Pakistan, Saeed Sons Falconry has grown through patience, skilled hands and a deep respect for the bird.',image:'/brand/story-2010.png',body:'Founded by Saeed Ahmad in Karachi in 2010, Saeed Sons Falconry brings together experienced workers and craftspeople who make field equipment with care. Our work is rooted in the ancient bond between falconer and bird, and refined for the way falconry is practiced today.'},craft:{eyebrow:'02 â€” THE MAKING',title:'Made slowly. Made to endure.',intro:'Every piece earns its place through material, hand and field.',image:'/brand/gloves-field-series.jpg',body:'We start with hides chosen for touch and strength, cut each panel with purpose, then finish the edge, stitch and fitting by hand. The result is equipment that becomes familiar in the hand instead of merely looking good on a shelf.'},products:{eyebrow:'03 â€” THE COLLECTIONS',title:'Tools for the open sky.',intro:'Explore gloves, hoods and perches shaped for real falconry.',image:'/brand/raw/perch-01.jpeg',body:'Choose a collection to begin. Each item is available by direct enquiry so we can confirm the right size, finish, availability and delivery before your order is placed.'}}[type];
